...
import { assets, features } from "../IMG/assets"; // Import images and feature data

function BottomBanner() {
  return (
    <div className="scale-[0.95]"> {/* Slight zoom effect on the whole section */}
      ...
      <div className="absolute inset-12 flex flex-col items-center md:items-end md:justify-center pt-16 md:pt-0 md:pr-24">
        <div>
