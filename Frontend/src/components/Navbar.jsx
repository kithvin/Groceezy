...
function Navbar() {
  ...
  // Go to product page when something is typed in search
  useEffect(() => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        {user && <NavLink to="/">Contact</NavLink>}{" "}
        ...
        {!user ? ( // Login button if user is not logged in
          <button
            ...
            className="cursor-pointer px-8 py-2  bg-primary hover:bg-primary-dull transition text-white rounded-full ml-3"
          >
            Login
          </button>
        ) : (
